        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
                <div class="flex-row text-center mx-auto">
                    ...
                    <div class="mx-auto">
                        <img class="" src="assets/img/favicon/LogoGestorExt.jpg" width="100" height="100"
                            alt="">

                        <h3>Descubra GestorExt</h3>
                        <p>
                            Un software dedicado a la gestion de horas extras de los empleados de su organizacion.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4">
                <div class="w-px-400 mx-auto">
                    ...
                    <!-- Register Card -->
                    <h4 class="mb-2">Bienvenido a GestorExt desarrollado por {{ config('variables.templateName') }}! 👋
                    </h4>
                    <p class="mb-4">Registrate para poder ingresar</p>
